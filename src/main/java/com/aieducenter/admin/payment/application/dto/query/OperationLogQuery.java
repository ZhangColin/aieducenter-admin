 ...
 *
 * <p>筛选字段对齐 payment {@code GET /api/v1/operation-logs} 查询参数。字段以 payment 实现契约为准。</p>
 *
 ...
 *
 * <p>枚举筛选项（{@code targetType} / {@code operation}）以 payment BaseEnum 的 Integer code 传递（payment 按 code 绑定枚举）。</p>
 *
 * @since 0.1.0
 */
